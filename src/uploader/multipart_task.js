...
class MultipartTask extends Task {
    ...
    _initiateMultipartUpload(file, chunkSize, bucket, object, options) {
        var self = this;
        var dispatcher = this.eventDispatcher;
    ...
    _listParts(file, bucket, object, uploadId) {
        var self = this;
        var dispatcher = this.eventDispatcher;
    ...
    _listAllParts(bucket, object, uploadId) {
